...
public ResponseEntity<String> create(@RequestBody Aula data) {

	try {
		aulaServiceApi.save(data);
...
public Map<String, Object> update(@PathVariable("id") Integer id, @RequestBody Aula data) {
