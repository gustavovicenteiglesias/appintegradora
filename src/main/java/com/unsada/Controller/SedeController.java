...
public ResponseEntity<String> create(@RequestBody Sede data) {

	try {
		
		sedeServiceApi.save(data);
...
public Map<String, Object> update(@PathVariable("id") Integer id, @RequestBody Sede data) {
